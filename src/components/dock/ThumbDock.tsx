...
export function ThumbDock({
  ...
  return (
    <div className="pointer-events-none relative z-40">
      <div className="mx-auto w-full max-w-screen-sm px-3 lg:max-w-4xl">
        <div className="relative">
          ...
          <motion.div
            className={[
              'pointer-events-auto flex items-center gap-3 rounded-[26px] border border-white/10 bg-black/55 px-4 py-3 shadow-[0_26px_80px_rgba(0,0,0,0.55)] backdrop-blur',
