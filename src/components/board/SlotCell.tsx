    ...
    >
      ...
      <AnimatePresence>
        {categoryCard ? (
          ...
          >
            <div
              className="w-[calc(var(--cardW)-12px)] min-w-0 overflow-hidden rounded-2xl border border-amber-200/60 bg-amber-300 px-2 py-0.5 text-center text-xs font-extrabold leading-snug tracking-wide text-amber-950 shadow-[0_10px_24px_rgba(0,0,0,0.18)] line-clamp-1 [word-break:break-word] lg:py-1"
      ...
      <div className="relative h-[var(--cardH)] w-[var(--cardW)]">
        ...
        {!categoryCard ? (
          ...
          >
            ...
            <div className="pointer-events-none absolute bottom-2 left-1/2 -translate-x-1/2 rounded-full bg-black/35 px-1.5 py-0.5 text-xs font-bold text-white/85 lg:px-2 lg:py-1">
              {progress}
            </div>
